...
clean-Src:
	-$(RM) ./Src/led_onboard.cyclo ./Src/led_onboard.d ./Src/led_onboard.o ./Src/led_onboard.su ./Src/main.cyclo ./Src/main.d ./Src/main.o ./Src/main.su ./Src/syscalls.cyclo ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
