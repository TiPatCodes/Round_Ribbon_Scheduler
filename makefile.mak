...
LDFLAGS_SH= -mcpu=$(MACH) -mthumb -mfloat-abi=soft --specs=rdimon.specs -T stm32_linkerscript.ld -Wl,-Map=final.map 

all: main.o led_onboard.o stm32_startupcode.o syscalls.o finalmake.elf

semi: main.o led_onboard.o stm32_startupcode.o finalsemi.elf 
...
finalsemi.elf: main.o led_onboard.o stm32_startupcode.O
	$(CC) $(LDFLAGS_SH) $^ -o $@
